...
if __name__=="__main__":
    ...
    # Plot AT2022tsd
    ax.scatter(9, -20.2, label=None, c=cowcol, edgecolor='k',
               marker='D', s=100, zorder=1000, lw=2)
    ax.text(8, -20.5, 'AT2022tsd', va='bottom', ha='center', color='k', fontweight='bold')
    ...
    ax.set_xlim(2.3,200)
    ax.set_xscale('log')
    ax.set_xlabel("Time above half-max (d)", fontsize=14)
